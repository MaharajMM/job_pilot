...
class AppColors {
  AppColors._();
  //primary colors
  static const Color kPrimaryBgColor = Color(0xFF122738);
  static const Color kPrimaryColor = Colors.yellow;
  // static const Color kPrimaryColor = Color(0xFF33ED30);
  // static const Color kPrimaryColor = Color(0xFFCBFF0A);
